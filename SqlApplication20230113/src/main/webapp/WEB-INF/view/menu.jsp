...
<body>
	...
	<%if(!itemList.isEmpty()){ %>
		...
		<tr>
			...
			<!-- 商品選択ボタンから注文ページへ遷移 -->
			<td><form action="NewOrderController" method="GET"><button type="submit" name="cartCode" value="<%=i+1 %>">新規注文</button></form></td>
		</tr>
	<% }} %>
		</table>
	<!-- 商品検索 -->
	...
	<tr>
		...
		<form action="MenuController" method="GET">
			<td>
				...
				<button type="submit" name="updateCartItem" value=<%=i%>>数量変更</button>
			<td>
				<button type="submit" name="deleteCartItem" value="<%=i%>">削除</button>
			</td>
		</form>
	</tr>
	<%}} %>
